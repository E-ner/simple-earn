      ...
      >
        ...
        {isSuccess ? (
          <motion.div 
            ...
            className="p-6 rounded-xl bg-(--accent)/5 border border-(--accent)/20 text-center space-y-6"
          >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              <label className="text-[9px] font-black uppercase tracking-widest text-(--text-tertiary)">{dict.auth.new_password}</label>
            ...
            <div className="space-y-2">
              <label className="text-[9px] font-black uppercase tracking-widest text-(--text-tertiary)">{dict.auth.confirm_new_password}</label>
              <div className="relative">
                <input
                  type="password"
                  required
...
export default function ResetPasswordPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-(--bg-base) flex items-center justify-center"><Loader2 className="animate-spin" /></div>}>
      <ResetPasswordForm />
    </Suspense>
  )
}
