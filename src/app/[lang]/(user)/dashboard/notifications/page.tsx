    ...
    <div className="flex flex-col gap-10 pb-20">
      <header className="flex flex-wrap items-end justify-between gap-4">
        ...
        {notifications.some(n => !n.isRead) && (
          <button 
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-md bg-white/[0.03] border border-white/5 text-[10px] font-black uppercase tracking-widest text-[var(--accent)] hover:bg-[var(--accent)]/10 transition-colors"
          >
      ...
      <div className="space-y-4">
          ...
          >
            ...
            <div className="flex-1 space-y-1">
              <div className="flex items-center justify-between">
                <h3 className={`text-[11px] font-black uppercase tracking-widest ${notif.isRead ? 'text-[#888]' : 'text-white'}`}>
                  {notif.title}
                </h3>
        ...
        {notifications.length === 0 && (
          <div className="py-24 border border-dashed border-white/5 rounded-md bg-white/[0.01] flex flex-col items-center justify-center text-center">
            <Bell className="w-10 h-10 text-[#222] mb-4" />
