  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[var(--bg-base)] px-4">
      <div className="text-center max-w-md space-y-6">
        <div className="mx-auto w-16 h-16 rounded-xl bg-[var(--gold-muted)] border border-[var(--gold)]/20 flex items-center justify-center">
          <ShieldOff className="w-8 h-8 text-[var(--gold)]" />
        </div>
        <div className="space-y-2">
          <p className="text-[10px] font-black uppercase tracking-widest text-[var(--gold)] font-mono">Error 403</p>
