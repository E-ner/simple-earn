    ...
    <div className="min-h-screen bg-[var(--bg-base)] flex items-center justify-center p-6">
      ...
      >
        <div className="mb-10 text-center lg:text-left">
          <Link href={`/${lang}/login`} className="inline-flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-[var(--accent)] mb-6 hover:opacity-80 transition-opacity">
          ...
          <p className="text-[10px] text-[var(--text-tertiary)] uppercase font-black tracking-widest leading-relaxed">
        ...
        {isSent ? (
          <motion.div 
            ...
            className="p-6 rounded-xl bg-[var(--accent)]/5 border border-[var(--accent)]/20 text-center space-y-4"
          >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              <label className="text-[9px] font-black uppercase tracking-widest text-[var(--text-tertiary)]">Verified Communication Channel (Email)</label>
