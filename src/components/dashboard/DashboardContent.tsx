  ...
  if (!dict) {
    return (
      <div className="h-96 flex items-center justify-center">
        <div className="w-8 h-8 rounded-md border-2 border-[var(--accent)] border-t-transparent animate-spin" />
      </div>
    )
  }
  ...
  return (
    <div className="flex flex-col gap-10 pb-20">
      <header className="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
        ...
        {/* Currency Toggle */}
        <div className="flex items-center gap-1 p-1 rounded-lg bg-[var(--surface-2)] border border-[var(--border)] self-start md:self-auto">
          {['USD', 'RWF'].map((curr) => (
            <button
              key={curr}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-4">
        ...
        <div className="lg:col-span-2 space-y-6">
          <motion.div 
            className="p-8 rounded-[var(--radius-xl)] bg-[var(--surface)] border border-[var(--border)] relative overflow-hidden group"
          ...
          >
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-lg font-bold text-[var(--text-primary)]">{dict?.dashboard?.strategy_title || 'Your Earning Strategy for Today'}</h3>
              </div>
              ...
              <div className="flex gap-4">
                <button 
                  ...
                  className="h-10 px-6 rounded-md bg-[var(--text-primary)] text-[var(--bg-elevated)] text-xs font-bold hover:opacity-90 transition-opacity"
                >
