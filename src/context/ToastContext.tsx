        ...
        <AnimatePresence>
          {toasts.map((toast) => (
            <motion.div
              ...
              className="pointer-events-auto group relative flex items-center gap-3 p-4 bg-[#16161e] border border-white/8 shadow-2xl rounded-md overflow-hidden"
            >
              {/* Progress bar */}
              <motion.div 
                initial={{ width: '100%' }}
                ...
                className={`absolute bottom-0 left-0 h-[2px] ${
                  ...
                  toast.type === 'WARNING' ? 'bg-yellow-500' : 'bg-(--accent)'
                }`}
              />
              ...
              <div className={`p-2 rounded-sm shrink-0 ${
                ...
                toast.type === 'WARNING' ? 'bg-yellow-500/10 text-yellow-500' : 'bg-(--accent)/10 text-(--accent)'
              }`}>
